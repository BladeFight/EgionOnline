...
public class AtavismTarget
{
	...
	{
		List<long> worldObjOIDs = ClientAPI.World.WorldObjectOIDs;
		List<ObjectNode> worldObjects = new List<ObjectNode> ();
		foreach (long worldObjOID in worldObjOIDs) {
			ObjectNode worldObj = ClientAPI.World.GetObjectByOID (worldObjOID);
	...
	public static ObjectNode GetCurrentTarget ()
	{
	...
	static ObjectNode _currentTarget;
	static ObjectNode _lastTarget;
	static ObjectNode _lastEnemy;
	static ObjectNode _mouseoverTarget;
	...
	static void _UpdateTarget (ObjectNode obj)
	{
	...
	static void _HandleObjectRemoved (ObjectNode worldObj)
	{
