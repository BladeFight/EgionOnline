...
public class DialogueUI : AtavismWindowTemplate {
	...
	void Start () {
		...
		// Register for 
		EventSystem.RegisterEvent("NPC_INTERACTIONS_UPDATE", this);
		EventSystem.RegisterEvent("DIALOGUE_UPDATE", this);
		EventSystem.RegisterEvent("QUEST_OFFERED_UPDATE", this);
		EventSystem.RegisterEvent("QUEST_PROGRESS_UPDATE", this);
	}
	...
	void OnDestroy () {
		EventSystem.UnregisterEvent("NPC_INTERACTIONS_UPDATE", this);
		EventSystem.UnregisterEvent("DIALOGUE_UPDATE", this);
		EventSystem.UnregisterEvent("QUEST_OFFERED_UPDATE", this);
		EventSystem.UnregisterEvent("QUEST_PROGRESS_UPDATE", this);
	}
