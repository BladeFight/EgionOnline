...
public class EffectsData: DataStructure
{
	...
	public string[] effectMainTypeOptions = new string[] {"Damage", "Heal", "Stat"};
	public string effectDamageType = "";
	public string[] effectDamageTypeOptions = new string[] {"MeleeStrike", "MagicalStrike", "PhysicalDot", "MagicalDot"};
	public string effectHealType = "";
	public string[] effectHealTypeOptions = new string[] {"HealInstant", "HealOverTime", "HealthTransfer"};
	public string effectStatType = "";
	public string[] effectStatTypeOptions = new string[] {"Stat"};
	...
	public string[] healPropertyOptions = new string[] {"health", "mana"};
	...
	public string[] damagePropertyOptions = new string[] {"health", "mana"};
