...
public class ServerItems : AtavismDatabaseFunction
{
	...
	{
		// Configure the correponding prefab
		item = new ItemPrefab(editingDisplay.id, editingDisplay.name);
		item.Save(editingDisplay.icon, editingDisplay.toolTip, editingDisplay.itemType, editingDisplay.subType, editingDisplay.slot, 
			editingDisplay.itemQuality, editingDisplay.purchaseCurrency, editingDisplay.purchaseCost, editingDisplay.sellable,
			editingDisplay.effects);
	}
